...
<div class="about-banner site-bg" style="background-image: url( '<?= esc_url( get_field( 'banner-image' )['url'] ); ?>' );">
	<div class="display-table width-100-pc full-height-percent">
		<div class="display-table-cell middle font25em text-center line-height-15 content-no-margin-top-bottom coresans-300"><?= get_field( 'banner-text' ); ?></div>
	</div>
</div>

<main class="site-light-gray-bg">

	<div class="top-paragraph text-center font30px-to-em line-height-15 content-no-margin-top-bottom coresans-300"><?= get_field( 'top-paragraph' )['paragraph']; ?></div>
	...
	<div class="left-right-content-wrapper clear-float">
		<div class="left-content-wrapper pull-left width-50-pc">
			...
			<div class="paragraph-wrapper paragraph-one line-height-15 font30px-to-em content-no-margin-top-bottom coresans-300" data-aos="fade-up" data-aos-duration="1000"><?= $left_content['paragraph-one']; ?></div>
		...
		<div class="right-content-wrapper pull-left width-50-pc">
			...
			<div class="paragraph-wrapper paragraph-one line-height-15 font18px-to-em content-no-margin-top-bottom" data-aos="fade-up" data-aos-duration="1000"><?= $right_content['paragraph-one']; ?></div>
	...
	<div class="bottom-paragraphs-wrapper clear-float">
		<div class="left-paragraph pull-left width-50-pc">
			...
			<div class="paragraph line-height-15 font30px-to-em content-no-margin-top-bottom coresans-300" data-aos="fade-up" data-aos-duration="1000"><?= $bottom_left_paragraph['paragraph']; ?></div>
		</div>
		<div class="right-paragraph pull-left width-50-pc">
			<?php $bottom_right_paragraph = get_field( 'bottom-right-paragraph' ); ?>
			<div class="paragraph line-height-15 font18px-to-em content-no-margin-top-bottom" data-aos="fade-up" data-aos-duration="1000"><?= $bottom_right_paragraph['paragraph']; ?></div>
		</div>
	</div>
